...
def output_results(out_path, ext_l0_to_l1_s, frames_idx,  title, start_time, plot=False, save=True):
    ...
    rot_diffs_relative, trans_diffs_relative  = utils.get_rot_trans_diffs_from_ext_mats(ext_l0_to_l1_s, ext_l0_to_l1_s_kitti)
